...
if(!isset($nocontroles) && empty($_SESSION['usuario'])){ //si la variable nocontroles no está definida en el archivo (no existe) y la variable de sesión usuario está vacía, el usuario no está identificado y no puede acceder a la página
